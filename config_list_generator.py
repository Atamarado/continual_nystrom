...
task_list = ["gtzan", "thumos", "electricity"]
                        ...
                        for model_seed in model_seed_list:
                            for num_layers in num_layers_list:
                                ...
                                for num_landmarks in [4]:
                                    ...
                                    params = "--data_seed {} --model_seed {} --model {} --num_layers {} --seq_len {} --dataset {} --fit_layer_epochs {} --num_landmarks {}\n".format(
                                        data_seed, model_seed, model, num_layers, seq_len, task, fit_layer_epochs, num_landmarks)
                                    f.write(params)